...
macro(rtmbuild_genbridge_init)
  ...
  foreach(_idl ${_idllist})
    ...
    message("[rtmbuild_genbridge_init] ${_rtmbuild_pkg_dir}/scripts/idl2srv.py --filenames -i ${PROJECT_SOURCE_DIR}/idl/${_idl} --include-dirs=\"${_include_dirs}\" --package-name=\"${PROJECT_NAME}\"")
    execute_process(COMMAND ${_rtmbuild_pkg_dir}/scripts/idl2srv.py --filenames -i ${PROJECT_SOURCE_DIR}/idl/${_idl} --include-dirs="${_include_dirs}" --package-name=${PROJECT_NAME} OUTPUT_VARIABLE _autogen_files OUTPUT_STRIP_TRAILING_WHITESPACE RESULT_VARIABLE _idl2srv_failed ERROR_VARIABLE _idl2srv_error)
    if (_idl2srv_failed)
	...
	message("[rtmbuild_genbridge_init] remove ${_autogen_files}")
      ...
      execute_process(COMMAND ${_rtmbuild_pkg_dir}/scripts/idl2srv.py -i ${PROJECT_SOURCE_DIR}/idl/${_idl} --include-dirs=${_include_dirs} --tmpdir=/tmp/idl2srv/${_project_name} --package-name=${PROJECT_NAME} RESULT_VARIABLE _idl2srv_failed ERROR_VARIABLE _idl2srv_error)
      if (_idl2srv_failed)
