...
macro(rtmbuild_add_executable exe)
  if (${use_catkin})
    ...
    add_dependencies(${exe} RTMBUILD_${PROJECT_NAME}_genidl rospack_genmsg rospack_gensrv)
...
macro(rtmbuild_add_library lib)
  if (${use_catkin})
    ...
    add_dependencies(${lib} RTMBUILD${PROJECT_NAME}_genidl ${${_package}_EXPORTED_TARGETS} ${catkin_EXPORTED_TARGETS}  rospack_genmsg rospack_gensrv)
