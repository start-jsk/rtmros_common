...
#language = None
#today_fmt = '%B %d, %Y'
exclude_patterns = ['/home/chen/ros/electric/rtm-ros-robotics/rtmros_common/hrpsys_ros_bridge/build/index.rst',]
#default_role = None
...
htmlhelp_basename = 'hrpsys_ros_bridgedoc'
