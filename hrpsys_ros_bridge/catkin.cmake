...
if($ENV{ROS_ROOT} MATCHES "/opt/ros/groovy/share/ros")
  message("sed -i s@'^\\(\\ *\\)<\\([a-z]*_depend\\)>pr2_controllers</\\([a-z]*_depend\\)>'@'\\1<!-- \\2>pr2_controllers</\\3 -->'@g ${PROJECT_SOURCE_DIR}/package.xml")
  execute_process(
  COMMAND sh -c "sed -i s@'^\\(\\ *\\)<\\([a-z]*_depend\\)>pr2_controllers</\\([a-z]*_depend\\)>'@'\\1<!-- \\2>pr2_controllers</\\3 -->'@g ${PROJECT_SOURCE_DIR}/package.xml"
  )
