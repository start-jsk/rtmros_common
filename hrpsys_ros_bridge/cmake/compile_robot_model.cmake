...
macro(compile_collada_model daefile)
  ...
  set(_lispfile "${_workdir}/${_name}.l")
  # use euscollada
  if(DEFINED USE_ROSBUILD AND NOT USE_ROSBUILD)
...
macro (generate_default_launch_eusinterface_files wrlfile project_pkg_name)
  ...
  configure_file(${hrpsys_ros_bridge_PACKAGE_PATH}/scripts/default_robot_startup.launch.in ${PROJECT_SOURCE_DIR}/build/${_sname}_startup.launch)
  configure_file(${hrpsys_ros_bridge_PACKAGE_PATH}/scripts/default_robot_ros_bridge.launch.in ${PROJECT_SOURCE_DIR}/build/${_sname}_ros_bridge.launch)
  if (NOT "${ARGV3}" STREQUAL "--no-toplevel-launch")
    configure_file(${hrpsys_ros_bridge_PACKAGE_PATH}/scripts/default_robot.launch.in ${PROJECT_SOURCE_DIR}/build/${_sname}.launch)
    configure_file(${hrpsys_ros_bridge_PACKAGE_PATH}/scripts/default_robot_nosim.launch.in ${PROJECT_SOURCE_DIR}/build/${_sname}_nosim.launch)
  endif()
