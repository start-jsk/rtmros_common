...
macro(get_conf_file_option _conf_file_option_ret)
  set(_arg_list ${ARGV})
  ...
  else (NOT "${_conf_file_option}" STREQUAL "")
    message("NOT FOUNTD CONF FILE OPTION ${_conf_file_option} ${_name}")
  endif (NOT "${_conf_file_option}" STREQUAL "")
  set(${_conf_file_option_ret} ${_conf_file_option})
endmacro(get_conf_file_option _conf_file_option_ret)
...
macro(compile_openhrp_model wrlfile)
  ...
  if("${ARGN}" STREQUAL "")
    ...
    get_conf_file_option(_conf_file_option ${ARGV})
  endif()
...
macro(compile_collada_model daefile)
  ...
  add_custom_command(OUTPUT ${_xmlfile}
    COMMAND rostest -t hrpsys _gen_project.launch INPUT:=${daefile} OUTPUT:=${_xmlfile} ${_conf_file_option}
    DEPENDS ${daefile})
