...
macro(get_conf_file_option _conf_file_option_ret _robothardware_conf_file_option_ret)
  ...
  get_option_from_args(${_conf_file_option} "--conf-file-option" "--conf-file-option\ " ' "CONF_FILE_OPTION:=" ${ARGV})
  get_option_from_args(${_robothardware_conf_file_option} "--robothardware-conf-file-option" "\ --robothardware-conf-file-option\ " ' "ROBOTHARDWARE_CONF_FILE_OPTION:=" ${ARGV})
