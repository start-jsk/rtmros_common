...
class HrpsysSeqStateROSBridge  : public HrpsysSeqStateROSBridgeImpl
{
 ...
 private:
  ros::NodeHandle nh;
  ros::Publisher joint_state_pub, joint_controller_state_pub, mot_states_pub, diagnostics_pub, clock_pub, zmp_pub, ref_cp_pub, act_cp_pub, odom_pub, imu_pub, em_mode_pub, ref_contact_states_pub, act_contact_states_pub, landing_target_pub;
  ros::Subscriber trajectory_command_sub, landing_height_sub;
