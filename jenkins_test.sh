...
function test-grxui {
    ...
    (cd `rospack find $package`; svn commit --non-interactive --username rtmrosrobotics.testing@gmail.com --password XC6HC3Jy2FG3 -m "update index.rst,conf.py by Jenkins" index.rst conf.py)
